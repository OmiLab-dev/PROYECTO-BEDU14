...
ui <- dashboardPage(
    ...
    dashboardBody(
        tabItems(
            tabItem("menu01",
                    h1("Programación y estadística con R (Santander)"),
                    h1("Implicaciones del COVID-19 en el sector tecnológico en México"),
                    img( src = "equipo.jpeg", height = 550, width = 700)
            ),
            tabItem("menu11",
                    h1("Introducción"), 
                    h4("A raíz de la situación de emergencia por COVID-19, se han identificado diferentes causas que generan un mayor número de defunciones; entre ellas las enfermedades  que engloban el síndrome metabólico (diabetes, hipertensión y obesidad) y la necesidad de salir a trabajar por no contar con las herramientas necesarias para realizar trabajo en casa (home office).  Debido a lo anterior, surge la idea de analizar si existe una relación entre la tecnología (internet, PC y TV) con la que cuenta un hogar
mexicano y las defunciones por COVID-19, con el propósito de determinar cuáles son las zonas más vulnerables y tomar acciones que disminuyan el número de casos. ")
            ...
            tabItem("menu12",
                    h1("Objetivo"),
                    h4("Identificar si existe una relación entre la tecnología en cada hogar de la República Mexicana y las defunciones por COVID-19.")
            ),
            tabItem("menu13",
                    h1("Hipotesis"), 
                    h4("Si existe un mayor índice de tecnología en los estados, entonces se presentará una menor incidencia de defunciones."),
                    h6("Referencias"), 
                    h6("Secretaría de Salud (2021) Datos abiertos de defunciones por COVID-19, 31-01-2021.  Recuperado de http://www.dgis.salud.gob.mx/contenidos/basesdedatos/da_defunciones_gobmx.html
"), 
            ...
            tabItem("menu22",
                    h1("Resultados"),
                    h2("Pregunta clave 1"),
                    h3("¿Existe una relación entre el índice de tecnología (internet, PC y TV) y el número de defunciones?")),
            tabItem("menu23",
                    h1("Población"),
                    h4("En el primer mapa se observa la distribución de la población por estado. En el mapa observamos mostrando una alta densidad en zonas como la Ciudad de México, Estado de México, Jalisco y Veracruz."), 
                    img( src = "poblacion_total.png", height = 550, width = 700)
            ),
            tabItem("menu24",
                    h1("Acceso a tecnología"), 
                    img( src = "tecnologia.png", height = 450, width = 600)
            ),
            tabItem("menu25",
                    h1("Distribución de tecnología"), 
                    img( src = "mapa_tecnologia.png", height = 550, width = 700)
            ),
            tabItem("menu26",
                    h1("Distribución de defunciones"),
                    img( src = "decesos.png", height = 550, width = 700)
            ),            
            tabItem("menu31",
                    h1("Resultados"), 
                    h3("Pregunta clave"), 
                    h4("¿Existe una relación entre el índice de tecnología y alguna de las causas (hipertensión, diabetes y obesidad) que generan el síndrome metabólico?")
            ),
            tabItem("menu32",
                    h1("Matriz de correlaciones"), 
                    img( src = "cor.png", height = 600, width = 1000)
            ),
            tabItem("menu33",
                    h1("Regresión lineal"), 
                    img( src = "regresion.png", height = 450, width = 750)
            ),
            tabItem("menu41",
                    h1("Conclusiones"),
                    h3("En el primer análisis, los estados de Guadalajara, CDMX, Monterrey y Área Metropolitana muestran un mayor índice de población, de tecnología y de defunciones con respecto al resto del país. Por su parte, la zona sur del país, muestra un índice menor de población, un nivel medio de tecnología y un menor índice de defunciones. Con estos datos se sugiere que el nivel de tecnología es indispensable para disminuir los casos de infección y de defunción. Sin embargo, es claro que ciudades que tienen un crecimiento de población mayor a la media, no cumplen con este criterio."),
                    h3("En el segundo análisis se encontró una correlación entre el internet y la diabetes con el número de defunciones. Esto nos indica que posiblemente la reducción de actividad física durante la pandemia, al tener posibilidades de hacer home office y actividades de recreación dentro de sus hogares (como el uso de servicios de streaming), podrían ser relevantes para el aumento de diabetes y defunciones. "),
                    h3("De acuerdo a lo anterior, se puede proponer diseñar nuevas estrategias de promoción de la salud para las personas que realizan home office y así mejorar el estilo de vida  entre la población ante las nuevas tendencias de prácticas laborales."),
            ...
            tabItem("menu42",
                    h1("Complicaciones"),
                    h3("En lo general, para mostrar mejor las densidades de tecnología y población, se necesitaba un tipo de gráfico distinto a los que vimos en clase, lo cual llevó a investigar nuevas opciones como el manejo de las librerías “mxmaps” y “corrplot”, que funcionan muy bien para demostrar este tipo de datos.")
            )
        )
    )
)
