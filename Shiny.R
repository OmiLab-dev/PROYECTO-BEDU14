...
"), h6("INEGI(2021) Censo de población y vivienda 2020. Recuperado de https://www.inegi.org.mx/programas/ccpv/2020/")),
            ...
            tabItem("menu21",h1("Datos obtenidos"), h4("De la base de datos INEGI y SSA, se seleccionaron por estado los siguientes datos:"), h4("- Población total."), h4("- Tecnologías (Internet, PC y TV)."), h4("- Defunciones por causas del síndrome metabólico (diabetes, hipertensión, obesidad)."), h4("Con estos datos, se elabora un data frame para realizar un análisis estadístico utilizando Rstudio."), tableOutput("data_table")),
